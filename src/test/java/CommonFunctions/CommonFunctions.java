...
public static void waitForElement(WebDriver driver,String locatortype,String locatorvalue,String waittitme) throws Exception{
	...
	public static WebDriver startBrowser(String browser) throws Exception{
		...
		{
			System.setProperty("webdriver.chrome.driver", "D:\\Selenium_Evening\\Cucumber_Framework\\CommonDriver\\chromedriver.exe");
			driver=new ChromeDriver();
		}
		else if(browser.equalsIgnoreCase("firefox"))
		{
			System.setProperty("webdriver.gecko.driver", "D:\\Anand_Morningbatch930\\Cucumber_FrameworkDec23\\CommonDrivers\\geckodriver.exe");
